...
class ConsumerControl(enum.IntEnum):
    ...
    def evdev(self):
        ...
        mapping = {
            ...
            # ConsumerControl.CC_DISPLAY_SET_BRIGHTNESS_TO_MINIMUM: 0,
            # ConsumerControl.CC_DISPLAY_SET_BRIGHTNESS_TO_MAXIMUM: 0,
            ...
            # ConsumerControl.CC_AL_MARKET_MONITOR_FINANCE_BROWSER: 0,
